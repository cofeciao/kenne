...
?>
            ...
            <div class="well-sip h-100">
                ...
                <div id="sip-log" class="h-100 d-none">
                    <div class="panel-heading">
                        <h4 class="text-muted panel-title mb-0">Recent Calls <span class="pull-right"><i
    ...
    <audio id="ringtone"
           src="<?= Yii::$app->assetManager->publish('@backendWeb/call-center/sounds/incoming.mp3')[1]; ?>"
           loop></audio>
    <audio id="ringbacktone"
           src="<?= Yii::$app->assetManager->publish('@backendWeb/call-center/sounds/outgoing.mp3')[1]; ?>"
           loop></audio>
    <audio id="dtmfTone"
           src="<?= Yii::$app->assetManager->publish('@backendWeb/call-center/sounds/dtmf.mp3')[1]; ?>"></audio>
...
$this->registerJsFile(Yii::$app->assetManager->publish('@backendWeb/call-center/js/sip.js')[1], ['depends' => AppAsset::class]);
$this->registerJsFile(Yii::$app->assetManager->publish('@backendWeb/call-center/js/VoipSIP.js')[1], ['depends' => AppAsset::class]);
$this->registerJsFile(Yii::$app->assetManager->publish('@backendWeb/call-center/js/custom.js')[1], ['depends' => AppAsset::class]);
$script = <<< JS
try{
var user = $call_center_config;
} catch (e) {
