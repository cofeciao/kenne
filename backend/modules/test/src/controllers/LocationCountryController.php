...
namespace modava\test\controllers;
...
use modava\test\models\search\LocationCountrySearch;
...
class LocationCountryController extends MyController
{
    ...
    */
    ...
    protected function findModel($id)
    {
        ...
        throw new NotFoundHttpException(Yii::t('test', 'The requested page does not exist.'));
    }
}
