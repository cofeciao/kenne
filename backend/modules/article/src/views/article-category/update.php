...
$this->title = Article::t('article', 'Update');
$this->params['breadcrumbs'][] = ['label' => Article::t('article', 'Article Categories'), 'url' => ['index']];
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"><?=  $this->title.': ' . $model->title; ?></h4>
