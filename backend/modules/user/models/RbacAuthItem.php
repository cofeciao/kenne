 ...
 * @property Item $item
 */
class RbacAuthItem extends Model
{
    /**
        ...
        if (!$this->manager->getRule($name)) {
            try {
                ...
                if ($rule instanceof Rule) {
                    ...
                    $this->addError('ruleName', Yii::t('rbac', 'Invalid rule "{value}"', ['value' => $name]));
                }
            } catch (\Exception $exc) {
                $this->addError('ruleName', Yii::t('rbac', 'Rule "{value}" does not exists', ['value' => $name]));
            }
        }
    }
