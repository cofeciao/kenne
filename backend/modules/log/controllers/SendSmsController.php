...
use backend\modules\log\models\search\SendSmsSearch;
use backend\components\MyController;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * SendSmsController implements the CRUD actions for Dep365SendSms model.
 */
class SendSmsController extends MyController
{
    ...
    /**
     * Updates an existing Dep365SendSms model.
    ...
    {
        if (($model = Dep365SendSms::findOne($id)) !== null) {
            return $model;
        }
