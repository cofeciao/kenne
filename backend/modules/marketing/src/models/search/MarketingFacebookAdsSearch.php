...
namespace modava\marketing\models\search;
...
/**
 * MarketingFacebookAdsSearch represents the model behind the search form of `modava\marketing\models\MarketingFacebookAds`.
 */
class MarketingFacebookAdsSearch extends MarketingFacebookAds
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = MarketingFacebookAds::find();
