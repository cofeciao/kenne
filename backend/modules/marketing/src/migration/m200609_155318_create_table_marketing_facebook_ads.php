...
/**
 * Class m200609_155318_create_table_marketing_facebook_ads
 */
class m200609_155318_create_table_marketing_facebook_ads extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $check_marketing_fb_ads = Yii::$app->db->getTableSchema('marketing_facebook_ads');
        if ($check_marketing_fb_ads === null) {
            $this->createTable('marketing_facebook_ads', [
                'id' => $this->primaryKey(),
    ...
    {
        echo "m200609_155318_create_table_marketing_facebook_ads cannot be reverted.\n";
