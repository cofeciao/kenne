...
<?php $form = ActiveForm::begin(); ?>
    <div class="hk-sec-wrapper">
        <div class="row collapse" id="search-panel">
            ...
            <div class="col-md-3 col-sm-4 col-lg-3">
                <div class="form-group row">
                    <div class="col-12">
                        <?= $form->field($model,
                            'keyword')->textInput(['maxlength' => true])->label(AffiliateModule::t('affiliate',
                            'Full Name, Phone, Code'))->input('text',
            ...
            <div class="col-md-2 col-sm-4 col-lg-2">
                <div class="form-group row">
                    <div class="col-12">
                        <?= $form->field($model, 'co_so')->label(AffiliateModule::t('affiliate',
                            'Cơ sở'))->dropDownList(
                            [
                                1 => 'Cơ sở 1',
                                2 => 'Cơ sở 2',
            ...
            <div class="col-md-2 col-sm-4 col-lg-2">
                <div class="form-group row">
                    <div class="col-12">
                        <?= $form->field($model, 'permission_user')->label(AffiliateModule::t('affiliate',
            ...
            <div class="col-md-3 col-sm-4 col-lg-3">
                <div class="form-group row">
                    <div class="col-12">
                        <?= $form->field($model, 'customer_come_time_to')->label(AffiliateModule::t('affiliate',
            ...
            <div class="col-md-2 col-sm-4 col-lg-2">
                <div class="form-group row">
                    <div class="col-12">
                        <?= $form->field($model, 'directsale')->label(AffiliateModule::t('affiliate',
            ...
            <div class="col-md-2 col-sm-4 col-lg-2">
                <div class="form-group row">
                    <div class="col-12">
                        <?= $form->field($model, 'nguon_online')->label(AffiliateModule::t('affiliate',
            ...
            <div class="col-md-3 col-sm-4 col-lg-3">
                <div class="form-group row">
                    <div class="col-12">
                        <?= $form->field($model, 'id_dich_vu')->label(AffiliateModule::t('affiliate',
                            'Nguồn'))->dropDownList(
            ...
            <div class="col-md-2 col-sm-4 col-lg-2">
                <div class="form-group row">
                    <div class="col-12">
                        <?= $form->field($model, 'thao_tac')->label(AffiliateModule::t('affiliate',
        ...
        <div class="row">
            <div class="col-12">
                <button type="submit" class="btn-primary btn btn-sm"><?= AffiliateModule::t('affiliate', 'Search') ?></button>
                <a href="<?= $currentRoute ?>" type="button" class="btn-success btn btn-sm"><?= AffiliateModule::t('affiliate',
                        'Default') ?></a>
                ...
                <button class="btn btn-primary btn-sm" data-toggle="collapse" data-target="#search-panel" aria-expanded="false" aria-controls="search-panel" type="button"><?= AffiliateModule::t('affiliate', 'Ẩn tìm kiếm') ?></button>
            </div>
        </div>
    </div>
<?php ActiveForm::end(); ?>