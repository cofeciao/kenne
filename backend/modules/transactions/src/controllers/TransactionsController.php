...
namespace modava\transactions\controllers;
...
use modava\transactions\models\search\TransactionsSearch;
...
class TransactionsController extends MyController
{
    ...
    */
    ...
    protected function findModel($id)
    {
        ...
        throw new NotFoundHttpException(Yii::t('transactions', 'The requested page does not exist.'));
    }
}
