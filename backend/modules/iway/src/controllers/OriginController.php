...
use modava\iway\models\search\OriginSearch;

/**
 * OriginController implements the CRUD actions for Origin model.
 */
class OriginController extends MyController
{
    /**
    * {@inheritdoc}
    */
    ...
    */
    ...
    /**
    * Displays a single Origin model.
    * @param integer $id
    * @return mixed
    ...
    */
    ...
    /**
    * Updates an existing Origin model.
    ...
    */
    ...
    /**
    * Deletes an existing Origin model.
    ...
    */
    ...
    /**
    * Finds the Origin model based on its primary key value.
    ...
    */
    ...
    {
        if (($model = Origin::findOne($id)) !== null) {
            return $model;
        }
