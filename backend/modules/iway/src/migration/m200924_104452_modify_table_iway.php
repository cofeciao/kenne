...
class m200924_104452_modify_table_iway extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addColumn('iway_appointment_schedule', 'doctor_thamkham', $this->integer(11)->null()->comment('Direct Sale phụ trách'));
        ...
        $this->addForeignKey('fk_iway_appointment_schedule_doctor_thamkham_user', 'iway_appointment_schedule', 'doctor_thamkham', 'user', 'id', 'RESTRICT', 'CASCADE');
