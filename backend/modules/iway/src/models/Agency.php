...
use modava\iway\models\table\AgencyTable;
use yii\behaviors\BlameableBehavior;
use yii\db\ActiveRecord;
use Yii;

/**
* This is the model class for table "iway_agency".
*
    * @property int $id
    ...
    *
            ...
            * @property AgencyOriginHasmany[] $iwayAgencyOriginHasmanies
            * @property Origin[] $origins
    */
class Agency extends AgencyTable
{
    public $toastr_key = 'agency';
