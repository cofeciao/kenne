...
class DropdownsConfig extends DropdownsConfigTable
{
    ...
    public function beforeSave($insert)
    {
        ...
        foreach ($this->dropdown_value as $value) {
            $dropdownValues[$value['key']] = $value['value'];
        }

        $this->dropdown_value = $dropdownValues;
    ...
    public static function getDropdowns($tableName)
    {
        ...
        foreach ($dropdownsResult as $model) {
            $dropdowns[$model->field_name] = $model->dropdown_value;
        }
