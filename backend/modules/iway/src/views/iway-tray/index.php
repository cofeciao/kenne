...
/* @var $searchModel modava\iway\models\search\IwayTraySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Iway Trays');
                                    ...
                                    ',
                                        ...
                                        'columns' => [
                                            ...
                                            [
                                                ...
                                                'template' => '{tray-images} {update} {delete}',
                                                'buttons' => [
                                                    'tray-images' => function ($url, $model) {
                                                        return Html::a('<span class="glyphicon glyphicon-picture"></span>', ['/iway/iway-tray-images/view', 'id' => $model->id], [
                                                            'title' => Yii::t('backend', 'Hình ảnh'),
                                                            'alia-label' => Yii::t('backend', 'Hình ảnh'),
                                                            'data-pjax' => 0,
