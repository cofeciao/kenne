...
$customers = CustomerTable::getAll();
?>
<?= ToastrWidget::widget(['key' => 'toastr-' . $model->toastr_key . '-form']) ?>
    <div class="customer-payment-form">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    <?= Select2::widget([
                        'model' => $model,
                        'attribute' => 'order_id',
                        'data' => ArrayHelper::map(OrderTable::getOrderUnFinishByCustomer($model->customer_id), 'id', 'code'),
                        'options' => [
                            'id' => 'select-order'
                        ]
                    ]) ?>
        ...
        <div class="form-group">
            <?= Html::submitButton(IwayModule::t('customer', 'Save'), ['class' => 'btn btn-success']) ?>
        </div>
...
$payments_thanh_toan = 'thanh_toan';
$payments_dat_coc = 'dat_coc';
$text_payments_dat_coc = $model->getDisplayDropdown($model->method, 'method');
$script = <<< JS
