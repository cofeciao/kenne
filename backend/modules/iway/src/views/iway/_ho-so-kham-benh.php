...
<ul class="nav nav-tabs custom-tab-line mb-3" id="defaultTabLine" role="tablist">
    <li class="nav-item">
        <a class="nav-link active" id="tab-line-1" data-toggle="tab" href="#tab-1" role="tab"
           aria-controls="tab-1" aria-selected="true"><i class="feather icon-layers mr-2"></i>Y lệnh</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="tab-line-2" data-toggle="tab" href="#tab-2" role="tab"
           aria-controls="tab-2" aria-selected="false"><i class="feather icon-image mr-2"></i>Hình ảnh</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="tab-line-3" data-toggle="tab" href="#tab-3" role="tab"
           aria-controls="tab-3" aria-selected="false"><i class="feather icon-image mr-2"></i>Video</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="tab-line-4" data-toggle="tab" href="#tab-4" role="tab"
           aria-controls="tab-4" aria-selected="false"><i class="feather icon-image mr-2"></i>File X-Quang</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="tab-line-5" data-toggle="tab" href="#tab-5" role="tab"
           aria-controls="tab-5" aria-selected="false"><i class="feather icon-image mr-2"></i>File STL</a>
    </li>
</ul>
        ...
        <form class="" action="" method="post">
            ...
            <div class="row mb-10 mx-0">
                ...
                <div class="col-lg-12">
                    <div class="custom-control custom-checkbox pull-left ml-15">
                        ...
                        <label class="custom-control-label v-a-m" for="arch_to_treat_7">Mẫu hàm chẩn đoán hàm đối diện</label>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="custom-control custom-checkbox pull-left ml-15">
            ...
            <div class="row mb-10 mx-0">
                <div class="custom-control custom-checkbox pull-left">
                    ...
                    <label class="custom-control-label v-a-m" for="tooth_movement_retrictions_02">Những răng sau không nên dịch chuyển</label>
                </div>
            </div>
            <div class="row mb-10 mx-0">
                <div class="card-body">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="default-datatable"
                            ...
                            <tr>
                                <td>Cải thiện tương quan răng nanh và răng cối (Nêu chi tiết ở mục yêu cầu đặc biệt)</td>
                                <td class="text-center">
                                    <div class="custom-control custom-checkbox pl-0">
            ...
            <div class="row mb-10 mx-0">
                <div class="custom-control custom-checkbox pull-left">
                    ...
                    <label class="custom-control-label v-a-m" for="anterior_posterior_tooth_movement1">Các lựa chọn dịch chuyển răng</label>
                </div>
                <p class="l-h-1c8">&nbsp;(Nếu lựa chọn nhiều hơn 1 chỉ định dưới đây thì chỉ định số lượng và trình tự tại mục Chỉ định đặc biệt)</p>
                <div class="col-lg-12">
                    <div class="custom-control custom-checkbox pull-left ml-15">
                        <input type="checkbox" class="custom-control-input setCheckboxYcommand"
                               name="anterior_posterior[]" value="10" id="anterior_posterior_tooth_movement2">
                        <label class="custom-control-label v-a-m" for="anterior_posterior_tooth_movement2">Cắt kẽ phía sau</label>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="custom-control custom-checkbox pull-left ml-15">
                        ...
                        <label class="custom-control-label v-a-m" for="anterior_posterior_tooth_movement">Chỉnh hạng II/III (Cần thêm khí cụ hỗ trợ carrier và thun hạng II)</label>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="custom-control custom-checkbox pull-left ml-15">
                        ...
                        <label class="custom-control-label v-a-m" for="anterior_posterior_tooth_movement4">Di xa tuần tự</label>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="custom-control custom-checkbox pull-left ml-15">
                        ...
                        <label class="custom-control-label v-a-m" for="anterior_posterior_tooth_movement5">Mô phỏng phẫu thuật chỉnh hình</label>
                    </div>
                </div>
                <div class="col-lg-12 mt-10">
                    <p>Chỉ định nhổ răng để chỉnh tương quan trước sau ở mục nhổ răng trong mục Răng thưa kẽ và răng chen chúc</p>
                </div>
            </div>
            ...
            <div class="row mb-10 mx-0">
                <div class="custom-control custom-checkbox pull-left">
                    <input type="checkbox" class="custom-control-input setCheckboxYcommand" name="overjet[]" value="1"
                           id="overjet1">
                    <label class="custom-control-label v-a-m" for="overjet1">Cho ra kết quả sau khi làm thẳng hàng</label>
                </div>
            </div>
            <div class="row mb-10 mx-0">
                <div class="custom-control custom-checkbox pull-left">
                    <input type="checkbox" class="custom-control-input setCheckboxYcommand" name="overjet[]" value="2"
                           id="overjet2">
                    <label class="custom-control-label v-a-m" for="overjet2">Giữ nguyên Overjet như ban đầu, có thể mài kẽ</label>
                </div>
            </div>
            <div class="row mb-10 mx-0">
                <div class="custom-control custom-checkbox pull-left">
            ...
            <div class="row mb-10 mx-0">
                <div class="custom-control custom-checkbox pull-left">
                    <input type="checkbox" class="custom-control-input setCheckboxYcommand" name="overbite[]" value="1"
                           id="overjet4">
                    <label class="custom-control-label v-a-m" for="overjet4">Cho ra kết quả sau khi làm thẳng hàng</label>
                </div>
            </div>
            <div class="row mb-10 mx-0">
                <div class="custom-control custom-checkbox pull-left">
                    <input type="checkbox" class="custom-control-input setCheckboxYcommand" name="overbite[]" value="2"
                           id="overjet5">
                    <label class="custom-control-label v-a-m" for="overjet5"> Giữ nguyên overbite như trước (Có thể cắt kẽ)</label>
                </div>
            </div>
            <div class="row mb-10 mx-0">
                <div class="custom-control custom-checkbox pull-left">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="custom-control custom-checkbox ml-15">
                        ...
                        <label class="custom-control-label v-a-m" for="overjet10">Làm trồi răng phía trước và làm lún răng phía sau</label>
                    </div>
                    <div class="md-full pl-40 mt-0">
                        <div class="md-full">
                            <div class="custom-control custom-checkbox pull-left">
                    ...
                    <div class="custom-control custom-checkbox ml-15">
                        ...
                        <label class="custom-control-label v-a-m" for="overjet13">Những chỉ định đặc biệt khác như phẫu thuật sẽ được yêu cầu tại mục Chỉ định đặc biệt</label>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-10 mx-0">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="custom-control custom-checkbox ml-15">
                        ...
                        <label class="custom-control-label v-a-m" for="overjet18">Làm lún răng phía trước và làm trồi răng phía sau</label>
                    </div>
                    <div class="md-full pl-40 mt-0">
                        <div class="md-full">
                            <div class="custom-control custom-checkbox pull-left">
                    ...
                    <div class="custom-control custom-checkbox ml-15">
                        ...
                        <label class="custom-control-label v-a-m" for="overjet21">Những chỉ định đặc biệt khác như phẫu thuật sẽ được yêu cầu tại mục Chỉ định đặc biệt</label>
                    </div>
                </div>
            </div>

            <div class="row mb-10 mt-20 mx-0">
                <h4 class="text-primary">7. Gờ được thiết kế ở mặt trong trên khay của răng cửa,răng nanh hàm trên để nâng khớp cắn</h4>
            </div>
            <div class="row mb-10 mx-0">
                <div class="custom-control custom-checkbox pull-left">
            ...
            <div class="row mb-10 mx-0">
                <div class="custom-control custom-checkbox pull-left">
                    ...
                    <label class="custom-control-label v-a-m" for="overjet23">Đặt Bite Ramps ở những răng hàm trên</label>
                </div>
                <div class="col-lg-12">
                    <div class="custom-control custom-checkbox pull-left ml-15">
                        <input type="checkbox" class="custom-control-input setCheckboxYcommand" name="bite_ramps[]"
                    ...
                    <p class="l-h-1c6">&nbsp;Chú ý: vị trí đặt Bite Ramps sẽ làm lún các răng phía trước hàm trên (khu vực tạo lực).</p>
            ...
            <div class="row mb-10 mx-0">
                <div class="custom-control custom-checkbox pull-left">
                    <input type="checkbox" class="custom-control-input setCheckboxYcommand" name="midline[]" value="1"
                           id="overjet28">
                    <label class="custom-control-label v-a-m" for="overjet28">Cho ra kết quả đường giữa sau khi làm thẳng hàng</label>
                </div>
            </div>
            <div class="row mb-10 mx-0">
                <div class="custom-control custom-checkbox pull-left">
                    <input type="checkbox" class="custom-control-input setCheckboxYcommand" name="midline[]" value="2"
                           id="overjet29">
                    <label class="custom-control-label v-a-m" for="overjet29">Giữ nguyên đường giữa như ban đầu (có thể đòi hỏi mài kẽ)</label>
                </div>
            </div>
            <div class="row mb-10 mx-0">
                <div class="custom-control custom-checkbox pull-left">
            ...
            <div class="row mb-10 ml-15">
                <div class="custom-control custom-checkbox pull-left">
                    ...
                    <label class="custom-control-label v-a-m" for="spacing_crowding3">Để lại những khoảng cụ thể (ghi rõ trong phần chỉ định đặc biệt)</label>
                </div>
            </div>
            <div class="row mb-10 mx-0">
                <div class="custom-control custom-checkbox pull-left">
            ...
            <div class="row mb-10 ml-15">
                <div class="custom-control custom-checkbox pull-left mb-10">
                    ...
                    <label class="custom-control-label v-a-m" for="resolve_lower_extractions3"> Nhổ các răng sau đây:</label>
                </div>
            </div>
