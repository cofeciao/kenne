                ...
                <div class="form-group row">
                    <div class="col-sm-9">
                        <fieldset class="form-group mt-0">
                            ...
                            <input type="file" datatype="stl" name="file[]" accept=".stl" multiple=""
                                   style="display: none" enctype="multipart/form-data" class="form-control inputUpload"
                ...
                <output class="result">
                    <div class="mb-30 box-image">
                        <a href="javascript:void(0)" data-toggle="modal" data-target=".bd-example-modal-tk">
                            <img src="<?= Yii::$app->assetManager->publish('@backendWeb/uploads/iway/document.png')[1] ?>" class="thumbnail">
                        </a>
