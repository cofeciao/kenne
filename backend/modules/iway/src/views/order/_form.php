        ...
        <div class="row">
            <?php if ($model->customer_id == null && Yii::$app->controller->action->id == 'create') { ?>
                <div class="col-md-6 col-12">
                    <?= Select2::widget([
                        ...
                        'data' => ArrayHelper::map(CustomerTable::getAll(), 'id', 'name'),
                        'options' => [
            ...
            <div class="col-md-6 col-12">
                ...
                if ($model->co_so == null) {
                    ...
                    if ($model->customer != null) $model->co_so = $model->customer->co_so;
                }
                ?>
            ...
            <?= $form->field($model, 'order_detail')->widget(MultipleInput::class, [
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'enableError' => true,
                        'items' => ArrayHelper::map(ProductTable::getAll(Yii::$app->language), 'id', 'name'),
                        'options' => [
...
<?php
$discount_by_money = Payment::DISCOUNT_BY_MONEY;
$discount_by_percent = Payment::DISCOUNT_BY_PERCENT;
$urlGetProductInfo = Url::toRoute(['/iway/product/get-product-info']);
$script = <<< JS
