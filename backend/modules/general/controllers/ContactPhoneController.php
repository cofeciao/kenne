...
use backend\modules\general\models\search\ContactPhoneSearch;
 ...
 */
class ContactPhoneController extends MyController
{
    public function actionIndex()
    {
        $searchModel = new ContactPhoneSearch();
    ...
    {
        if (($model = ContactPhone::findOne($id)) !== null) {
            return $model;
        }
