...
/* @var $searchModel backend\modules\general\models\search\Dep365NotificationSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Thông báo');
...
<section id="dom">
    ...
    [
                        ...
                        <div style="margin-top:5px;border:1px solid #ccc;border-radius:3px">
                            <?php Pjax::begin(['id' => 'GeneralNotification', 'timeout' => false, 'enablePushState' => false, 'clientOptions' => ['method' => 'GET']]); ?>
                            <?= MyGridView::widget([
...
var general = new myGridView({
    pjaxId: '#GeneralNotification',
    urlChangePageSize: '$urlChangePageSize',
});
$('body').on('beforeSubmit', 'form#form-notification', function(e){
    e.preventDefault();
   var currentUrl = $(location).attr('href');
   var formData = $('#form-notification').serialize();
    
    $('#form-notification').myLoading({opacity: true});
