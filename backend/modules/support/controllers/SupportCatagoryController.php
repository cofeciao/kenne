...
use backend\modules\support\models\search\SupportCatagorySearch;
...
/**
 * SupportCatagoryController implements the CRUD actions for SupportCatagory model.
 */
class SupportCatagoryController extends MyController
{
    public function actionIndex()
    {
        $searchModel = new SupportCatagorySearch();
    ...
    /**
     * Updates an existing SupportCatagory model.
    ...
    {
        if (($model = SupportCatagory::findOne($id)) !== null) {
            return $model;
        }
