...
/* @var $searchModel modava\slide\models\search\SlideTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = SlideModule::t('slide', 'Slide Types');
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper index">
                    ...
                    <?php Pjax::begin(['id' => 'slide-pjax', 'timeout' => false, 'enablePushState' => true, 'clientOptions' => ['method' => 'GET']]); ?>
                    <div class="row">
                        <div class="col-sm">
                            <div class="table-wrap">
                                <div class="dataTables_wrapper dt-bootstrap4 table-responsive">
                                    <?= MyGridView::widget([
                                        ...
                                        'pager' => [
                                            'firstPageLabel' => SlideModule::t('slide', 'First'),
                                            'lastPageLabel' => SlideModule::t('slide', 'Last'),
                                            'prevPageLabel' => SlideModule::t('slide', 'Previous'),
                                            'nextPageLabel' => SlideModule::t('slide', 'Next'),
                                            'maxButtonCount' => 5,
                                        ...
                                        'columns' => [
                                            ...
                                            [
                                                ...
                                                'value' => function ($model) {
                                                    if ($model->image == null)
                                                        return null;
                                                    return Html::img(Yii::$app->params['slide-type']['150x150']['folder'] . $model->image, ['width' => 150, 'height' => 150]);
                                                },
                                                'headerOptions' => [
                                                    'width' => 150,
                                                ],
                                            ...
                                            [
                                                ...
                                                'header' => SlideModule::t('slide', 'Actions'),
                                                'template' => '{update} {delete}',
                                                'buttons' => [
                                                    'update' => function ($url, $model) {
                                                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>', $url, [
                                                            'title' => SlideModule::t('slide', 'Update'),
                                                            'alia-label' => SlideModule::t('slide', 'Update'),
                                                            'data-pjax' => 0,
                                                    ...
                                                    'delete' => function ($url, $model) {
                                                        return Html::a('<span class="glyphicon glyphicon-trash"></span>', 'javascript:;', [
                                                            'title' => SlideModule::t('slide', 'Delete'),
                                                            'class' => 'btn btn-danger btn-xs btn-del',
                                                            'data-title' => SlideModule::t('slide', 'Delete?'),
                                                            'data-pjax' => 0,
                                                            'data-url' => $url,
