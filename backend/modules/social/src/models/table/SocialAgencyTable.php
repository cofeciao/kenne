...
use cheatsheet\Time;
use modava\social\models\query\SocialAgencyQuery;
use Yii;
use yii\db\ActiveRecord;

class SocialAgencyTable extends \yii\db\ActiveRecord
{
    ...
    {
        return 'social_agency';
    }

    public static function find()
    {
        return new SocialAgencyQuery(get_called_class());
    }
    ...
    {
        return $this->hasMany(SocialOriginTable::class, ['id' => 'origin_id'])
            ->viaTable('social_agency_origin_hasmany', ['agency_id' => 'id']);
    }
