    ...
    public function safeUp()
    {
        ...
        if ($check_customer_payment === null) {
            ...
            $this->createTable('customer_payment', [
                ...
                'payments' => $this->integer(11)->notNull()->comment('"Loại thanh toán: Đặt cọc, thanh toán, ..."'),
                'type' => $this->integer(11)->notNull()->comment('"Hình thức thanh toán: Chuyển khoản, tiền mặt, ..."'),
