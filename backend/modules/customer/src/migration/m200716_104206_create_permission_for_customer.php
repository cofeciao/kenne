...
('customerCustomer-fanpageGet-fanpage-by-origin', 2, 'Backend - Customer - Get fanpage by origin', NULL, NULL, 1594883283, 1594883283),
('customerCustomer-orderCreate', 2, 'Backend - Customer - Create order', NULL, NULL, 1594885640, 1594885640),
('customerCustomer-orderGet-order-by-customer', 2, 'Backend - Customer - Get order by customer', NULL, NULL, 1594887574, 1594887574),
('customerCustomer-orderIndex', 2, 'Backend - Customer - Index order', NULL, NULL, 1594885687, 1594885687),
('customerCustomer-orderUpdate', 2, 'Backend - Customer - Update order', NULL, NULL, 1594886169, 1594886169),
('customerCustomer-orderValidate-order', 2, 'Backend - Customer - Validate order', NULL, NULL, 1594886098, 1594886098),
('customerCustomer-orderView', 2, 'Backend - Customer - View order', NULL, NULL, 1594885704, 1594885704),
('customerCustomer-originGet-origin-by-agency', 2, 'Backend - Customer - Get origin by agency', NULL, NULL, 1594883223, 1594883223),
('customerCustomer-paymentCreate', 2, 'Backend - Customer - Create payment', NULL, NULL, 1594886462, 1594886462),
('customerCustomer-paymentGet-payment-info', 2, 'Backend - Customer - Get payment info', NULL, NULL, 1594886527, 1594886527),
('customerCustomer-paymentIndex', 2, 'Backend - Customer - Payment', NULL, NULL, 1594886416, 1594886416),
('customerCustomer-paymentUpdate', 2, 'Backend - Customer - Update payment', NULL, NULL, 1594886665, 1594886665),
('customerCustomer-paymentView', 2, 'Backend - Customer - View payment', NULL, NULL, 1594886476, 1594886476),
('customerCustomer-productGet-product-info', 2, 'Backend - Customer - Get product info', NULL, NULL, 1594886071, 1594886071),
('customerCustomerCreate', 2, 'Backend - Khách hàng - Tạo mới khách hàng', NULL, NULL, 1594640884, 1594640884),
('customerCustomerDelete', 2, 'Backend - Khách hàng - Xóa khách hàng', NULL, NULL, 1594640934, 1594640934),
('customerCustomerIndex', 2, 'Backend - Khách hàng - Danh sách khách hàng', NULL, NULL, 1594640867, 1594640867),
('customerCustomerUpdate', 2, 'Backend - Khách hàng - Cập nhật khách hàng', NULL, NULL, 1594640918, 1594640918),
('customerCustomerValidate', 2, 'Backend - Customer - Validate customer', NULL, NULL, 1594883347, 1594883347),
('customerCustomerView', 2, 'Backend - Customer - View', NULL, NULL, 1594883390, 1594883390),
('customerRemind-call', 2, 'Backend - Customer - Remind call', NULL, NULL, 1594873378, 1594873378),
('locationLocation-districtGet-district-by-province', 2, 'Backend - Location - Get district by province', NULL, NULL, 1594873148, 1594873148),
('locationLocation-provinceGet-province-by-country', 2, 'Backend - Location - Get province by country', NULL, NULL, 1594873101, 1594873101),
('locationLocation-wardGet-ward-by-district', 2, 'Backend - Location - Get ward by district', NULL, NULL, 1594873191, 1594873191);
         * */
