...
/**
* This is the model class for table "customer_status_dat_hen".
*
    * @property int $id
    ...
    * @property int $accept 0: không đến, 1: đến
    ...
    */
class CustomerStatusDatHen extends CustomerStatusDatHenTable
{
    public $toastr_key = 'customer-status-dat-hen';
