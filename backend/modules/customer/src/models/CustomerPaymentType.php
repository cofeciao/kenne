...
use modava\customer\models\table\CustomerPaymentTypeTable;
use yii\behaviors\BlameableBehavior;
use yii\db\ActiveRecord;
use Yii;

/**
* This is the model class for table "customer_payment_type".
*
    * @property int $id
    ...
    */
class CustomerPaymentType extends CustomerPaymentTypeTable
{
    public $toastr_key = 'customer-payment-type';
