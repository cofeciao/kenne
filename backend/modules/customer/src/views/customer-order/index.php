                                            ...
                                            [
                                                ...
                                                'buttons' => [
                                                    ...
                                                    'payment' => function ($url, $model) {
                                                        return Html::a('<span class="glyphicon glyphicon-plus"></span>', ['/customer/customer-treatment-schedule/index', 'order_id' => $model->id], [
                                                    ...
                                                    'list-payment' => function ($url, $model) {
                                                        return Html::a('<span class="glyphicon glyphicon-credit-card"></span>', ['/customer/customer-treatment-schedule/index', 'order_id' => $model->id], [
