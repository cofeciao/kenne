...
use backend\modules\setting\models\search\Dep365CoSoSearch;
...
/**
 * CoSoController implements the CRUD actions for Dep365CoSo model.
 */
class CoSoController extends MyController
{
    ...
    {
        $searchModel = new Dep365CoSoSearch();
    ...
    /**
     * Updates an existing Dep365CoSo model.
    ...
    public function actionUpdateRenderVirtual()
    {
        if (Yii::$app->request->isAjax) {
            $id = Yii::$app->request->post('id');
            ...
            $model = $this->findModel($id);
            try {
                if ($model->render_virtual_booking == 1) {
                    $model->render_virtual_booking = 0;
                } else {
                    $model->render_virtual_booking = 1;
                }
                if ($model->save()) {
                    echo 1;
                }
    ...
    {
        if (($model = Dep365CoSo::findOne($id)) !== null) {
            return $model;
        }
