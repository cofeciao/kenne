...
/* @var $searchModel modava\kenne\models\search\SubcribesSearch */
...
<div class="container-fluid px-xxl-25 px-xl-10">
    ...
    <div style="margin-bottom: 1%">
        <a class="btn btn-outline-light" href="<?= \yii\helpers\Url::to(['subcribes/send-all']); ?>"
           title="<?= KenneModule::t('kenne', 'Send News'); ?>">
            <i class="fa fa-inbox"></i> <?= KenneModule::t('kenne', 'Send All'); ?></a>
    </div>
