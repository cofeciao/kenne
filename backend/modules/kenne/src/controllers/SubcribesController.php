...
use modava\kenne\models\search\SubcribesSearch;

/**
 * SubcribesController implements the CRUD actions for Subcribes model.
 */
class SubcribesController extends MyController
{
    /**
    * {@inheritdoc}
    */
...
//        /return $this->redirect('/subcribes');
    ...
    {
        $searchModel = new SubcribesSearch();
    ...
    /**
    * Displays a single Subcribes model.
    * @param integer $id
    * @return mixed
    ...
    */
    ...
    /**
    * Updates an existing Subcribes model.
    ...
    */
    ...
    /**
    * Deletes an existing Subcribes model.
    ...
    */
    ...
    /**
    * Finds the Subcribes model based on its primary key value.
    * If the model is not found, a 404 HTTP exception will be thrown.
    * @param integer $id
    * @return Subcribes the loaded model
    * @throws NotFoundHttpException if the model cannot be found
    */
    ...
    {
        if (($model = Subcribes::findOne($id)) !== null) {
            return $model;
        }
