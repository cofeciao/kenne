                                        ...
                                        <div class="card-body pa-0 mnh-250p">
                                            <div id="owl_demo_1" class="owl-carousel dots-on-item owl-theme">
                                                <div class="fadeOut item img-background overlay-wrap"
                                                     style="background-image:url(<?= Yii::$app->assetManager->publish('@backendWeb/dist/img/gallery/mock7.jpg')[1]; ?>">
                                                    <div class="position-relative z-index-2 pa-20">
                                                        <div class="position-relative text-white mnh-225p">
                                                            <p>Very easy to use. Thanks to design, we've just
                                                                launched our 5th website! Thank you for making it
                                                                painless, pleasant and most of all hassle free! Just
                                                                ...
                                                                <div class="media-img-wrap d-flex mr-15">
                                                                    <div class="avatar avatar-sm">
                                                                            <span class="avatar-text avatar-text-inv-success rounded-circle"><span
                                                                                        class="initial-wrap"><span>ZC</span></span></span>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="fadeOut item img-background overlay-wrap"
                                                     style="background-image:<?= Yii::$app->assetManager->publish('@backendWeb/dist/img/gallery/mock8.jpg')[1]; ?>">
                                                    <div class="position-relative z-index-2 pa-20">
                                                        <div class="position-relative text-white mnh-225p">
                                                            <p>Nice work on your design. Design is worth much more
                                                                than I paid. We've used design for the last five
                                                                years. I just can't get enough of design.</p>
                                                            <div class="media position-absolute b-0 l-0 align-items-center">
                                                                <div class="media-img-wrap d-flex mr-15">
                                                                    <div class="avatar avatar-sm">
                                                                            <span class="avatar-text avatar-text-inv-success rounded-circle"><span
                                                                                        class="initial-wrap"><span>NT</span></span></span>
                                                                    </div>
                                                                </div>
                                                                <div class="media-body">
                                ...
                                <div class="col-md-6">
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="progress progress-bar-xs mt-30">
                                                <div class="progress-bar bg-danger w-55" role="progressbar"
                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="progress progress-bar-xs mt-30">
                                                <div class="progress-bar bg-success w-85" role="progressbar"
